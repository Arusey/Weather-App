...
/// Activity indicator handler
class WaitingOverlays: NSObject {
    ...
    fileprivate class func addMainWindowBlocker() -> UIView {
        /// Igor - `UIApplication.shared.delegate.window` result nil
        /// Changed it like that but it needs to be reviewed
